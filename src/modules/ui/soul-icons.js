...
export const SOUL_ICONS = {
  // ── 普通 (common) ──
  "蓝银草":    { img: "/souls/common/蓝银草.png",    theme: "grass" },
  "镰刀":      { img: "/souls/common/镰刀.png",      theme: "metal" },
  "香草":      { img: "/souls/common/香草.png",      theme: "nature" },
  "木棍":      { img: "/souls/common/木棍.png",      theme: "wood" },
  "含羞草":    { img: "/souls/common/含羞草.png",    theme: "grass" },
  "铁锤":      { img: "/souls/common/铁锤.png",      theme: "metal" },
  "渔网":      { img: "/souls/common/渔网.png",      theme: "water" },
  "蒲公英":    { img: "/souls/common/蒲公英.png",    theme: "wind" },
  "芦苇杆":    { img: "/souls/common/芦苇杆.png",    theme: "water" },
  "铁锅":      { img: "/souls/common/铁锅.png",      theme: "metal" },
  "荆棘藤":    { img: "/souls/common/荆棘藤.png",    theme: "grass" },
  "石头":      { img: "/souls/common/石头.png",      theme: "earth" },
  "陶笛":      { img: "/souls/common/陶笛.png",      theme: "wind" },

  // ── 稀有 (rare) ──
  "白虎":        { img: "/souls/rare/白虎.png",        theme: "beast" },
  "火凤凰":      { img: "/souls/rare/火凤凰.png",      theme: "fire" },
  "冰凤凰":      { img: "/souls/rare/冰凤凰.png",      theme: "ice" },
  "盘龙棍":      { img: "/souls/rare/盘龙棍.png",      theme: "dragon" },
  "七宝琉璃塔":  { img: "/souls/rare/七宝琉璃塔.png",  theme: "holy" },
  "幽冥灵猫":    { img: "/souls/rare/幽冥灵猫.png",    theme: "dark" },
  "碧磷蛇皇":    { img: "/souls/rare/碧磷蛇皇.png",    theme: "poison" },
  "金龙爪":      { img: "/souls/rare/金龙爪.png",      theme: "dragon" },
  "朱雀圣火":    { img: "/souls/rare/朱雀圣火.png",    theme: "fire" },
  "玄武神盾":    { img: "/souls/rare/玄武神盾.png",    theme: "water" },
  "白鹤翎羽":    { img: "/souls/rare/白鹤翎羽.png",    theme: "wind" },
  "青龙护卫":    { img: "/souls/rare/青龙护卫.png",    theme: "dragon" },
  "冰火蛟龙":    { img: "/souls/rare/冰火蛟龙.png",    theme: "dragon" },
  "雷电狼王":    { img: "/souls/rare/雷电狼王.png",    theme: "thunder" },
  "幽灵蝶":      { img: "/souls/rare/幽灵蝶.png",      theme: "dark" },
  "赤炎狮王":    { img: "/souls/rare/赤炎狮王.png",    theme: "fire" },
  "碧海银鲸":    { img: "/souls/rare/碧海银鲸.png",    theme: "water" },
  "紫电金鹰":    { img: "/souls/rare/紫电金鹰.png",    theme: "thunder" },
  "幽影黑豹":    { img: "/souls/rare/幽影黑豹.png",    theme: "dark" },
  "碎星陨铁":    { img: "/souls/rare/碎星陨铁.png",    theme: "metal" },

  // ── 史诗 (epic) ──
  "蓝电霸王龙":  { img: "/souls/epic/蓝电霸王龙.png",  theme: "thunder" },
  "昊天锤":      { img: "/souls/epic/昊天锤.png",      theme: "metal" },
  "六翼天使":    { img: "/souls/epic/六翼天使.png",    theme: "holy" },
  "泰坦巨猿":    { img: "/souls/epic/泰坦巨猿.png",    theme: "beast" },
  "噬魂蛛皇":    { img: "/souls/epic/噬魂蛛皇.png",    theme: "dark" },
  "死亡蛛皇":    { img: "/souls/epic/死亡蛛皇.png",    theme: "dark" },
  "冰碧帝皇蝎":  { img: "/souls/epic/冰碧帝皇蝎.png",  theme: "ice" },
  "烈火剑圣":    { img: "/souls/epic/烈火剑圣.png",    theme: "fire" },
  "星辰神兽":    { img: "/souls/epic/星辰神兽.png",    theme: "holy" },
  "雷霆战神":    { img: "/souls/epic/雷霆战神.png",    theme: "thunder" },
  "极寒冰皇":    { img: "/souls/epic/极寒冰皇.png",    theme: "ice" },
  "焰灵骑士":    { img: "/souls/epic/焰灵骑士.png",    theme: "fire" },
  "黄金圣龙":    { img: "/souls/epic/黄金圣龙.png",    theme: "dragon" },
  "狂风战鹰":    { img: "/souls/epic/狂风战鹰.png",    theme: "wind" },
  "暗域鬼王":    { img: "/souls/epic/暗域鬼王.png",    theme: "dark" },
  "极焱炎神":    { img: "/souls/epic/极焱炎神.png",    theme: "fire" },
